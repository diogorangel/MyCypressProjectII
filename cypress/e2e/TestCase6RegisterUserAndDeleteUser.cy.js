...
describe('User Authentication Scenarios', () => {
  ...
  it('Test Case 6: Register User and delete User', () => {
    // Cenário 6: Registrar um novo usuário e exclui-lo
    ...
    //SignupPage.deleteAccountButton1.should('be.visible');
    //SignupPage.deleteAccountButton2.should('be.visible');
    SignupPage.continueButton.click();
  });
});